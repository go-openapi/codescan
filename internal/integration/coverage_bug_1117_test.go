...
// TestCoverage_Bug1117 documents the answer to go-swagger issue #1117 ("how to define response as
// array type"): give the swagger:response an in:body field of a slice type; the response schema
// becomes {type: array, items: {$ref}}.
//
