...
// TestCoverage_Bug3117 locks go-swagger issue #3117 ("spec generating type property along with
// schema references"): a body parameter whose schema is a $ref must NOT also carry a sibling `type:
// object` (which is invalid Swagger 2.0).
//
// The body param schema is a clean $ref.
