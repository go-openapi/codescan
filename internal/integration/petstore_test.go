...
func TestAppScanner_Definitions(t *testing.T) {
	...
	scantest.CompareOrDumpJSON(t, doc, "bookings_spec.json")
}

func verifyParsedPetStore(t *testing.T, doc *oaispec.Swagger) {
	t.Helper()
...
func verifyTop(t *testing.T, doc *oaispec.Swagger) {
	t.Helper()
...
func verifyCommonResponses(t *testing.T, responses map[string]oaispec.Response) {
	t.Helper()
	...
	t.Run("with responses", func(t *testing.T) {
		...
		t.Run("should define genericError", func(t *testing.T) {
			...
			scantest.AssertProperty(t, resp.Schema, "integer", "code", "int32", "Code")
			scantest.AssertProperty(t, resp.Schema, "string", "message", "", "Message")
		})
		...
		t.Run("should define validationError", func(t *testing.T) {
			...
			scantest.AssertProperty(t, resp.Schema, "integer", "code", "int32", "Code")
			scantest.AssertProperty(t, resp.Schema, "string", "message", "", "Message")
			scantest.AssertProperty(t, resp.Schema, "string", "field", "", "Field")
		})
...
func verifyModels(t *testing.T, definitions oaispec.Definitions) {
	t.Helper()
	...
	t.Run("with models definitions", func(t *testing.T) {
		...
		require.TrueT(t, ok)
		assert.Equal(t, oaispec.StringOrArray([]string{"object"}), mod.Type)
		...
		scantest.AssertProperty(t, &mod, "integer", "id", "int64", "ID")
		...
		scantest.AssertProperty(t, &mod, "string", "value", "", "Value")
		...
		scantest.AssertProperty(t, &mod, "string", "name", "", "Name")
		...
		scantest.AssertArrayProperty(t, &mod, "string", "photoUrls", "", "PhotoURLs")
		...
		scantest.AssertProperty(t, &mod, "string", "status", "", "Status")
		...
		scantest.AssertProperty(t, &mod, "string", "birthday", "date", "Birthday")
		prop, ok = mod.Properties["birthday"]
		assert.TrueT(t, ok)
		assert.EqualT(t, "The pet's birthday", prop.Description)

		scantest.AssertArrayRef(t, &mod, "tags", "Tags", "#/definitions/tag")
		...
		scantest.AssertProperty(t, &mod, "integer", "userId", "int64", "UserID")
		...
		scantest.AssertProperty(t, &mod, "string", "orderedAt", "date-time", "OrderedAt")
		...
		scantest.AssertArrayProperty(t, &mod, "object", "items", "", "Items")
		...
		scantest.AssertProperty(t, itprop, "integer", "petId", "int64", "PetID")
		...
		scantest.AssertProperty(t, itprop, "integer", "qty", "int32", "Quantity")
...
func verifyIDParam(t *testing.T, param oaispec.Parameter, description string) {
	t.Helper()
...
func verifyRefParam(t *testing.T, param oaispec.Parameter, description, refed string) {
	t.Helper()
