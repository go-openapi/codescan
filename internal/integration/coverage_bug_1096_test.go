...
// TestCoverage_Bug1096 locks the fix for go-swagger issue #1096 ("annotated go code fails to
// generate spec when using cgo"): a package that imports "C" used to yield an empty spec; it now
// scans normally via go/packages.
//
