...
// TestCoverage_Bug2106 locks go-swagger issue #2106 ("Extensions ignored on
// models when type is not an array"): a field-level `Extensions:` block emits its
// x-* vendor extensions on BOTH scalar and array fields.
