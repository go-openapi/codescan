...
// TestNormalizeBullet covers the markdown-bullet → canonical `- ` rewrite that makes `* item` / `+ item` lists
// identifiable like `- item` (go-swagger#1726).
...
// TestTrimContentPrefixBullets locks the end-to-end content-prefix behaviour: leading godoc decoration is shed and a
// markdown bullet is normalised, while the YAML fence and prose are preserved.
