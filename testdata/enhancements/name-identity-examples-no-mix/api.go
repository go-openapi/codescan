...
import (
	"github.com/go-openapi/codescan/testdata/enhancements/name-identity-examples-no-mix/a"
	"github.com/go-openapi/codescan/testdata/enhancements/name-identity-examples-no-mix/b"
)
