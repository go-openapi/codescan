...
| `swagger:omit` | embed / type doc | drops named fields from what an embed promotes | [how-to]({{% relref "composing-embeds-with-allof" %}}) | [reference]({{% relref "/maintainers/annotations/swagger-omit" %}}) |
