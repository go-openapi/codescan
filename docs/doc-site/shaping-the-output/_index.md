...
description: |
  ...
  Grouped by what they shape: scope & discovery, names & $refs, titles & descriptions, field types & formats,
  and response bodies.
---
...
Each guide is task-oriented — *"I want the output to look like this"* — and shows the **same input rendered both ways**,
as before/after golden output the example tests verify. For the field-by-field meaning of every option,
see the [Options reference]({{% relref "options-reference" %}})
or the [`Options` godoc](https://pkg.go.dev/github.com/go-openapi/codescan#Options).
