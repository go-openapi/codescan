...
// The palette.
//
// Constants rather than variables: a theme nothing can reassign at runtime is one less thing a rendering bug can be.
const (
...
//
// The diagnostic classes underline as well as recolour: underline is the terminal's squiggle, and it survives a palette
// where the severity colour is close to a syntax one.
