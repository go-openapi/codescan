...
// textarea NORMALISES the text it is given — tabs become spaces — so comparing
// the buffer against the file marked every tab-indented Go file as edited the
// moment it was opened: a ● in the title, and a STALE badge on follow, with
// nothing touched. The buffer is the baseline, not the bytes on disk.
